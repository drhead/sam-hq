...
pl_loader = pl.ParallelLoader(dataloader,xm.get_xla_supported_devices("TPU",8))
...
def _mp_fn(index):
    ...
    train_loader = pl_loader.per_device_loader(xm.xla_device()) # SERIAL_EXEC.run(lambda: load_dataset())
